...
\begin{flushleft}
\large David Falk (736532)\\Christian Lichtsinn (736787)\\Praktikum 1 \& 2: 19.10.15 \& 02.11.15: \textbf{Mo-56x}
\end{flushleft}
\end{minipage}
\hfill
...
\bottomrule
\end{tabular}
\captionof{table}{\label{tab:resonanzkurve}Messwerte zur Bestimmung der Resonanzkurve.}
\end{center}

\begin{center}
\includegraphics[width=0.7\linewidth]{resonanzkurve.png}
\captionof{figure}{\label{fig:resonanzkurve}Resonanzkurve.}
\end{center}
