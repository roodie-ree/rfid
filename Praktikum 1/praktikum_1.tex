...
\usepackage{graphicx,textcomp,mathpazo}
...
Zusätzlich gab es noch weitere Barcodes, die kurze Texte codiert hatten, die da waren: esaip Angers, h\_da, ?, fbi, Haardtring, D-64295,
wwwfbi, IRT2, IRT3, Ralf Mayer, Email, enjoy the rfid lesson -und- good luck for all your scanning.
...
Der Barcode ließ sich geschätzt mit bis zu einem $\SI{0.5}{\meter}$ Meter Abstand vom Lesegerät erfassen. Bis zu einem geschätzten
