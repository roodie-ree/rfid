...
public class SerialCommunication {
    ...
    public final byte STX = 0x2;
    public final byte ETX = 0x3;
    public final String GET_AMOUNT = "6C20S";
    public final String GET_INVENTORY = "6C21";
    public static SerialPort serialPort;
    private String[] inventory;

    public String[] gimmeid() {
        ...
        try {
            ...
            inventory = processGetInventory(response);
            /*
    ...
    private String[] processGetInventory(String response) {
    ...
    private String receiveResponse() throws SerialPortException {
        int bufferSize = 1024;
        int i = 0;
